...
Second_button = st.sidebar.button("AML/CFT Zero To Hero Course !!! 👨‍🎓") 
          if Second_button:
                    webbrowser.open('https://www.udemy.com/course/amlcft-zero-to-hero-course/?referralCode=CD51C836B3518E24CA71')
...
def main():
    ...
    if choice == "Login":
        ...
        authenticator = stauth.Authenticate(names, usernames, hashed_passwords, "ML_app", "abcdef", cookie_expiry_days=30)
        ...
        #------------------MAIN PROGRAM ------------------------------#
            ...
            if st.button("Sign Up"):
                if password != confirm_password:
                    ...
                    # # (This code assumes you have a function called create_account() that adds a new account to your database)
                     ...
                     st.info("Select Login option to login")
